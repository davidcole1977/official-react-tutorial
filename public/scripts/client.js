...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_commentBox.CommentBox, { url: '/api/comments', pollInterval: 2000 }), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function transformMarkdown(markdown) {
	  var rawMarkup = (0, _marked2.default)(markdown, { sanitize: true });
	...
	var Comment = exports.Comment = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('span', { dangerouslySetInnerHTML: this.transformMarkdown(this.props.children.toString()) }),
	      _react2.default.createElement('span', { dangerouslySetInnerHTML: transformMarkdown(this.props.children.toString()) })
	    );
	  }
	});
